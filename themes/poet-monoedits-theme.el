;;; poet-monoedits-theme.el --- A monochrome theme for prose.
...
(deftheme poet-monoedits
  "A monoedits prose friendly theme")
...
(let ((fg "#303030")
      ...
      (imenu "#3e3e3e"))
 (custom-theme-set-faces 'poet-monoedits
 ...
 (custom-theme-set-variables 'poet-monoedits
  '(line-spacing .2)
  `(fci-rule-color ,fci)))
...
(provide-theme 'poet-monoedits)
(provide 'poet-monoedits-theme)
;;; poet-monoedits-theme.el ends here
